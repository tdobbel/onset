...
The fraction of sediments produced by SB reaching HBSC1-CP remained negligible for any grain sizes. No sediment particles reached the sites of Rainbow Reef and Emerald Reef for all grain sizes. However, some particles reached VKR for grain sizes coarser than 100 $\mu$m. These sediments particles almost entirely originated from SB. Nonetheless, the impact of the dredging on VKR remained limited with less than 0.01$\%$ of the released particles reaching the site.
